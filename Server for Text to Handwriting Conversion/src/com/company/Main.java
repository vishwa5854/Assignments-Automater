...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        generatePicture();
        File file = new File(Files.DIRECTORY_PATH + Files.OUTPUT_FILE_NAME + ".jpg");
    ...
    private static void generatePicture(){
    ...
    private static void writeFinalGeneratedImage(BufferedImage writeImage) {
        File writer = new File(Files.DIRECTORY_PATH + Files.OUTPUT_FILE_NAME + ".jpg");
        try {
